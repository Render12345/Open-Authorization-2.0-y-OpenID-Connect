...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .provider-btn.twitch:hover {
            border-color: rgba(145,70,255,.7);
            box-shadow: 0 4px 24px rgba(145,70,255,.2);
        }
        
        .twitch .provider-icon { background: rgba(145,70,255,.12); }
...
<div class="card">
    ...
    <a href="{{ route('auth.redirect', 'twitch') }}" class="provider-btn twitch">
        <div class="provider-icon">
            <svg viewBox="0 0 24 24" fill="#9146FF" xmlns="http://www.w3.org/2000/svg">
                <path d="M11.571 4.714h1.715v5.143H11.57zm4.715 0H18v5.143h-1.714zM6 0L1.714 4.286v15.428h5.143V24l4.286-4.286h3.428L22.286 12V0zm14.571 11.143l-3.428 3.428h-3.429l-3 3v-3H6.857V1.714h13.714z"/>
            </svg>
        </div>
        <div class="btn-label">
            <strong>Continuar con Twitch</strong>
            <small>OAuth 2.0 · scopes: user:read:email</small>
        </div>
        <span class="btn-arrow">→</span>
    </a>
